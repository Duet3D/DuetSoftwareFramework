...
namespace DuetUnitTest.Commands
{
    ...
    public class Code
    {
        ...
        public void Parse()
        {
            ...
            code = new DuetAPI.Commands.Code("M106 P1 C\"Fancy \"\" Fan\" H-1 S0.5");
            ...
            Assert.AreEqual("Fancy \" Fan", code.Parameters[1].Value);
            ...
            code = new DuetAPI.Commands.Code("M569 P2 S1 T0.3");
            Assert.AreEqual(DuetAPI.Commands.CodeType.MCode, code.Type);
            ...
            code = new DuetAPI.Commands.Code("T3 P4");
