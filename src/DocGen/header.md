...
If you are capable of editing source code, it is encouraged to make pull requests for the original [DSF API code](https://github.com/Duet3D/DuetSoftwareFramework/tree/v3.7-dev/src/DuetAPI/ObjectModel) instead.

This page refers to version 3.7 of the Object Model.
