...
public interface IModelCollection : IStaticModelObject, INotifyCollectionChanged
{
    ...
    void UpdateFromJson(JsonElement jsonElement, int offset = 0, bool last = true);
    ...
    /// <param name="offset">Index offset</param>
    /// <param name="last">Whether this is the last update</param>
    void UpdateFromJsonReader(ref Utf8JsonReader reader, int offset = 0, bool last = true);
}
