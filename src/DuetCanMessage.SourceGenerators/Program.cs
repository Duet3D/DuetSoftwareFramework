...
using DuetCanMessage.SourceGenerators.Emit;
using DuetCanMessage.SourceGenerators.Model;

namespace DuetCanMessage.SourceGenerators;
...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        string schemaPath = options.GetValueOrDefault("schema")
            ?? Path.Combine(repoRoot, "src/DuetCanMessage.SourceGenerators/Schema/can-messages.json");
        ...
        [
            ...
            (options.GetValueOrDefault("cpp-tables-out") ?? Path.Combine(repoRoot, "src/DuetCanMessage.SourceGenerators/generated/cpp/CanMessageGenericTables.h"),
             cppTables.Emit()),
