...
namespace DuetUnitTest.Machine
{
    ...
    public class Move
    {
        ...
        public void Assign()
        {
            ...
            Assert.AreNotSame(original.Move.Axes[0].Drives, assigned.Move.Axes[0].Drives);
            Assert.AreNotSame(original.Move.Axes[0].Homed, assigned.Move.Axes[0].Homed);
            Assert.AreNotSame(original.Move.Axes[0].Letter, assigned.Move.Axes[0].Letter);
            Assert.AreNotSame(original.Move.Axes[0].MachinePosition, assigned.Move.Axes[0].MachinePosition);
            Assert.AreNotSame(original.Move.Axes[0].Max, assigned.Move.Axes[0].Max);
            Assert.AreNotSame(original.Move.Axes[0].Min, assigned.Move.Axes[0].Min);

            Assert.AreNotSame(original.Move.BabystepZ, assigned.Move.BabystepZ);
            Assert.AreNotSame(original.Move.Compensation, assigned.Move.Compensation);
            Assert.AreNotSame(original.Move.CurrentMove.RequestedSpeed, assigned.Move.CurrentMove.RequestedSpeed);
            Assert.AreNotSame(original.Move.CurrentMove.TopSpeed, assigned.Move.CurrentMove.TopSpeed);

            Assert.AreNotSame(original.Move.Drives[0].Acceleration, assigned.Move.Drives[0].Acceleration);
            Assert.AreNotSame(original.Move.Drives[0].Current, assigned.Move.Drives[0].Current);
            Assert.AreNotSame(original.Move.Drives[0].MaxSpeed, assigned.Move.Drives[0].MaxSpeed);
            Assert.AreNotSame(original.Move.Drives[0].Microstepping.Interpolated, assigned.Move.Drives[0].Microstepping.Interpolated);
            Assert.AreNotSame(original.Move.Drives[0].Microstepping.Value, assigned.Move.Drives[0].Microstepping.Value);
            Assert.AreNotSame(original.Move.Drives[0].MinSpeed, assigned.Move.Drives[0].MinSpeed);
            Assert.AreNotSame(original.Move.Drives[0].Position, assigned.Move.Drives[0].Position);

            Assert.AreNotSame(original.Move.Extruders[0].Factor, assigned.Move.Extruders[0].Factor);
            Assert.AreNotSame(original.Move.Extruders[0].Nonlinear.A, assigned.Move.Extruders[0].Nonlinear.A);
            Assert.AreNotSame(original.Move.Extruders[0].Nonlinear.B, assigned.Move.Extruders[0].Nonlinear.B);
            Assert.AreNotSame(original.Move.Extruders[0].Nonlinear.Temperature, assigned.Move.Extruders[0].Nonlinear.Temperature);
            Assert.AreNotSame(original.Move.Extruders[0].Nonlinear.UpperLimit, assigned.Move.Extruders[0].Nonlinear.UpperLimit);

            Assert.AreNotSame(original.Move.Geometry.Type, assigned.Move.Geometry.Type);
            Assert.AreNotSame(original.Move.Idle.Factor, assigned.Move.Idle.Factor);
            Assert.AreNotSame(original.Move.Idle.Timeout, assigned.Move.Idle.Timeout);
            Assert.AreNotSame(original.Move.SpeedFactor, assigned.Move.SpeedFactor);
        }
    }
}
