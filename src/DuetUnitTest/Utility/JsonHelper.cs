...
namespace DuetUnitTest.Utility
{
    ...
    public class Json
    {
        ...
        public void Merge()
        {
            ...
            MachineModel newModel = serializedA.ToObject<MachineModel>();
            ...
            Assert.AreEqual(1, newModel.Heat.Beds[0].Active.Count);
            Assert.AreEqual(100F, newModel.Heat.Beds[0].Active[0], 0.0001F);
            Assert.AreEqual("BED2", newModel.Heat.Beds[1].Name);
            Assert.AreEqual(1, newModel.Heat.Beds[1].Standby.Count);
            Assert.AreEqual(20F, newModel.Heat.Beds[1].Standby[0], 0.0001F);
            Assert.AreEqual(1, newModel.Fans.Count);
            Assert.AreEqual(0.5, newModel.Fans[0].Value);
            Assert.AreEqual(MachineStatus.Pausing, newModel.State.Status);
