...
public static class Writer
{
    ...
    public static int WriteCode(Span<byte> to, DuetAPI.Commands.Code code, int protocolVersion)
    {
        ...
        CodeHeader header = new()
        {
            ...
            MinorCode = (code.MinorNumber >= 0) ? code.MinorNumber : 0,
    ...
    /// </summary>
    /// <param name="code">Code to write</param>
    /// <param name="bufferSize">Size of the buffer to write to</param>
    /// <param name="protocolVersion">Protocol version</param>
    /// <returns>Code size in bytes</returns>
    /// <exception cref="ArgumentException">Thrown if the code is too long to fit into the buffer</exception>
