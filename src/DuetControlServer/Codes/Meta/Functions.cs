...
public class Functions
{
    ...
    public async Task<object?> Exists(CodeChannel channel, string functionName, object?[] arguments)
    {
    ...
    /// <param name="arguments">Function arguments</param>
    /// <returns>Whether the file exists</returns>
    public async Task<object?> FileExists(CodeChannel channel, string functionName, object?[] arguments)
    {
        if (arguments.Length == 1 && arguments[0] is string stringArgument)
        {
    ...
    /// <returns></returns>
    public async Task<object?> FileRead(CodeChannel channel, string functionName, object?[] arguments)
    {
