...
namespace DuetControlServer.Commands
{
    ...
    public sealed class Flush : DuetAPI.Commands.Flush, IConnectionCommand
    {
        ...
        public override async Task<bool> ExecuteAsync(CancellationToken cancellationToken = default)
        {
            ...
            return await ((codeBeingIntercepted is not null) ? Codes.Processor.FlushAsync(codeBeingIntercepted, false, false, SyncFileStreams, IfExecuting, cancellationToken) : Codes.Processor.FlushAsync(Channel, cancellationToken: cancellationToken));
        }
    }
}
