...
public partial class Observer
{
    ...
    /// </summary>
    private readonly Dictionary<IModelCollection, NotifyCollectionChangedEventHandler> _collectionChangeHandlers = [];
    ...
    private NotifyCollectionChangedEventHandler CollectionChanged(string collectionName, params object[] path)
    {
        return (sender, e) =>
        {
    ...
    private NotifyCollectionChangedEventHandler MessageCollectionChanged(params object[] path)
    {
        return (_, e) =>
        {
    ...
    private void SubscribeToModelCollection(IModelCollection modelCollection, string collectionName, object[] path)
    {
    ...
    private void UnsubscribeFromModelCollection(IModelCollection modelCollection)
    {
