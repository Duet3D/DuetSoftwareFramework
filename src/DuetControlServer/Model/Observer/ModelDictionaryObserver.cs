...
public partial class Observer
{
    ...
    private void ModelDictionaryChanging(object? sender, PropertyChangingEventArgs e)
    {
    ...
    /// </summary>
    private readonly Dictionary<IModelDictionary, PropertyChangedEventHandler> _dictionaryChangedHandlers = [];
    ...
    private PropertyChangedEventHandler DictionaryChanged(object[] path)
    {
        return (sender, e) =>
        {
    ...
    /// Dictionary of model objects vs property change handlers
    /// </summary>
    private readonly Dictionary<IModelDictionary, EventHandler> _dictionaryClearedHandlers = [];
    ...
    /// <param name="path">Property path</param>
    /// <returns>Property change handler</returns>
    private EventHandler DictionaryCleared(object[] path)
    {
        return (_, _) =>
        {
    ...
    private void SubscribeToModelDictionary(IModelDictionary modelDictionary, object[] path)
    {
    ...
    private void UnsubscribeFromModelDictionary(IModelDictionary modelDictionary)
    {
