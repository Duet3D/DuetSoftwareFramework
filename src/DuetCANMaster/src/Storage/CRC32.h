...
class CRC32
{
  ...
  public:
	...
	__attribute__((optimize("no-unroll-loops"))); // we already optimised the loops, and on the SAME5x unrolling them
												  // could make us feed data to the CRC unit too fast
#endif
};
