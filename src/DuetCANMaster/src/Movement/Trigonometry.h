...
// Calculate 248 times the sine and cosine of the phase value passed, where phase is between 0 and 4095, and 4096 would
// correspond to 2*pi The phase is normally in the range 0 to 4095 but when tuning it can be 0 to somewhat over 8192. We
// must take it modulo 4096. The reason for using 248 not 255 is this paragraph from section 16.2 of the TMC2160A data
// sheet: "The maximum resulting swing of the wave should be adjusted to a range of -248 to 248, in order to give the
// best possible resolution while
