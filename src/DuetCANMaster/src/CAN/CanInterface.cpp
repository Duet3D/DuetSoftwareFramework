...
// We expect the time stamp to be up to a few milliseconds old. If that's not the case, ignore the
// timestamp in the message and return the current master time.
