...
namespace CommandProcessor
{
	...
	bool ForwardMessageToSbc(CanMessageBuffer& buf) noexcept; // Forward a received CAN message to the SBC, collating
															  // multi-fragment replies. False if its queue was full
