...
| LockObjectModel | Lock the object model for write access (deprecated, will be removed in v3.7) | ObjectModelReadWrite |
| SetObjectModel | Set a single key in the object model (deprecated, will be removed in v3.7) | ObjectModelReadWrite |
| SyncObjectModel | Wait for the object model to be fully synchronized | CommandExecution, ObjectModelRead, ObjectModelReadWrite |
| UnlockObjectModel | Unlock the object model again, see LockObjectModel (deprecated, will be removed in v3.7) | ObjectModelReadWrite |
