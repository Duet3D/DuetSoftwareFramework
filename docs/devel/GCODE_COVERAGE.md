...
> [!NOTE]
> Changes to be made after human review, not by AI
...
Each of the three tracking columns is ✅, ⛔, or 🟡 followed by what is missing. A blank cell means nobody has
checked that command yet, which is not the same as ⛔.

| Command | Parameters | Description | Regression tested | System tested | Fully implemented | Notes |
| --- | --- | --- | --- | --- | --- | --- |
